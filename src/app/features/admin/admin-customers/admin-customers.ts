...
@Component({
  ...
  template: `
    <div class="grid md:grid-cols-5 gap-6">
      <div class="md:col-span-2 bg-white border border-line rounded-2xl overflow-hidden h-fit">
      ...
      <div class="md:col-span-3 bg-white border border-line rounded-2xl p-6 h-fit">
        @if (!selected()) {
          <p class="text-sub text-sm">Select a customer to view their order history.</p>
        } @else if (loadingOrders()) {
          <p class="text-sub text-sm">Loading order history...</p>
        } @else {
